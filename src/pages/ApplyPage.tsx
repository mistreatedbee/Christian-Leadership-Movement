...
export function ApplyPage() {
  ...
  if (!user) {
    // Show the forms but with login prompt
    return (
      <div className="min-h-screen flex flex-col">
        <TopNav />
        <main className="flex-grow py-12 px-4 bg-muted-gray">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-card p-6 mb-8">
                <p className="text-blue-800 mb-4">
                  Please log in to access the application forms
                </p>
                <Button
                  variant="primary"
                  onClick={() => navigate('/login?redirect=/apply')}
                >
                  Login to Continue
                </Button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-card shadow-soft p-8 hover:shadow-lg transition-shadow opacity-75">
