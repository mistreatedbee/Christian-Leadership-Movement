...
-- Run this entire script in your new InsForge project
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.payments (
  ...
  payment_type TEXT NOT NULL CHECK (payment_type IN ('application', 'membership', 'course', 'donation')),
...
-- =====================================================
-- 17. RLS POLICIES - PUBLIC READ TABLES
-- =====================================================
...
-- =====================================================
-- 18. RLS POLICIES - USER-SPECIFIC TABLES
-- =====================================================
...
-- =====================================================
-- 20. INITIAL DATA - FEE SETTINGS
-- =====================================================

INSERT INTO public.fee_settings (fee_type, amount, currency, description) VALUES
  ('membership_application', 500.00, 'ZAR', 'Membership application fee'),
  ('bible_school_with_acrp', 2500.00, 'ZAR', 'Bible School registration with ACRP'),
  ('bible_school_without_acrp', 2000.00, 'ZAR', 'Bible School registration without ACRP')
...
-- =====================================================
-- Next steps:
-- 1. Create storage buckets: applications, courses, gallery, avatars
